...
def evaluation(model:SimcseModel, dataloader:DataLoader, device:Union[str,torch.device]):
    """模型评估函数
...
def main(args):
    ...
    model = SimcseModel(pretrained_model=args.pretrain_model_path,
                        pooling=args.pooler,
